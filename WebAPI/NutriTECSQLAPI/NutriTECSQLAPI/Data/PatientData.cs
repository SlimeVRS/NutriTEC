...
namespace NutriTECSQLAPI.Data
{
    public class PatientData
    {
        ...
        public static bool GiveNewNutritionist(PatientNutritionist patient)
        {
            using (SqlConnection connection = new SqlConnection(Connection.connectionStringSQL))
            {
                SqlCommand cmd = new SqlCommand("usp_modifypatientnutritionist", connection);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@id_patient", patient.id_patient);
                cmd.Parameters.AddWithValue("@id_nutritionist_patient", patient.id_nutritionist);
                try
                {
                    connection.Open();
                    cmd.ExecuteNonQuery();
        ...
        public static List<Patient> GetAllUnrelatedPatients()
        {
            List<Patient> patientList = new List<Patient>();
            using (SqlConnection connection = new SqlConnection(Connection.connectionStringSQL))
            {
                SqlCommand cmd = new SqlCommand("usp_getallunrelatedpatients", connection);
                cmd.CommandType = CommandType.StoredProcedure;
                try
                {
                    connection.Open();
